...
const SignupPage = () => {
  ...
  const { signup, authWithDiscord, isAuthenticated } = useAuth();
          ...
          <Card className="p-8">
            {isAuthenticated ? (
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Account creation is disabled while you are signed in.</p>
                <Button className="w-full" onClick={() => navigate('/discover')}>
                  Go to Discover
                </Button>
              </div>
            ) : (
